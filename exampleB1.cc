...
//  #define G4MULTITHREADED // disable for single thread
...
#include "G4VisExecutive.hh" // enable this for visualization
...
int main(int argc,char** argv)
{
    ...
    { // we loop from min_energy to max_energy in steps of step_size; each file will have the energy as part of filename
        ...
        //
        G4VisManager* visManager = new G4VisExecutive; // enable for visualization
        ...
        delete visManager; //enable for visualization
        delete runManager;
