...
{ 
  ...
  // Create ntuple with 5 columns
  analysisManager->CreateNtuple("PhotonData", "Photon Information in CylDetector");
  analysisManager->CreateNtupleIColumn("PID");        // Column 0: Particle ID (integer)
  analysisManager->CreateNtupleDColumn("PosX");       // Column 1: Position X (double)
